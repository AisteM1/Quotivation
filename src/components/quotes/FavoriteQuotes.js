        ...
        <section class='favorite-quotes'>
          <div className= "wrapper quotes">
            ...
            <div className='favorite-quotes-description'>
                <p>
                    {" "}
                     You can add {remainingQuotes} more {remainingQuotes === 1 ? "quote" : "quotes"} to your top three favorites by selecting from the options below. </p>
                <p> Once you choose, they will appear here.
